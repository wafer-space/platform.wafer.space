...
# Per-check container memory policy (applied in tasks_checks.do_starting):
...
CELERY_BEAT_SCHEDULE = {
    ...
    "checks-cleanup-superseded": {
        "task": "wafer_space.projects.tasks_checks.checks_cleanup_superseded",
        "schedule": 60.0,
    },
