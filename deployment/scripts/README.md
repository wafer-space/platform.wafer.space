...
- Secret file must exist: `/home/django/.secrets/test-user`
...
echo 'your-secure-password' > test-user
git add test-user && git commit -m 'Add E2E test user password' && git push
```
